...
function BookshelfSearch({ query, books, shelfName, initialIndex, alwaysDisplay, setSearchActive, setBooks }: Props) {
  ...
  return (
    <div className="flex flex-col pt-10">
      <h2 className="flex items-end gap-4 text-2xl font-medium">Showing results for: <p className="text-xl italic">{query}</p></h2>
      <div className='grid grid-cols-2 pt-20 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
